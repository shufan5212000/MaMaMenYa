...
namespace MAMAMENYA.FormWeb.Tests.Data.NHibernateMaps
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public virtual void SetUp()
        {
            ...
            //  var cc = new AutoPersistenceModelGenerator().Generate();
            configuration =
            NHibernateSession.Init(new ThreadSessionStorage(), mappingAssemblies,
                                   new AutoPersistenceModelGenerator().Generate(),
                                   "../../../MAMAMENYA.FormWeb/NHibernate.config");
        }
