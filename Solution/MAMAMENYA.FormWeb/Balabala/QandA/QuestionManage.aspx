<%@ Page Title="" Language="C#" MasterPageFile="~/MAMAYA.Master" AutoEventWireup="true" CodeBehind="QuestionManage.aspx.cs" Inherits="MAMAMENYA.FormWeb.Balabala.QandA.QuestionManage" %>
            ...
            <tr>
                ...
                <td class="detail">
                    <select size="1" name="ENTPdept" id="bumen">
                        ...
                        <% foreach (var articleClass in QuestionClasses)
                           {
  %>
  ...
  <%
            ...
            <tr>
                <td colspan="6" align="right">
                    <a  class="btnsearch btn btn-inverse "  href="QandAList.aspx">查询</a>
                    </td>
            </tr>
        </tbody>
    </table>
