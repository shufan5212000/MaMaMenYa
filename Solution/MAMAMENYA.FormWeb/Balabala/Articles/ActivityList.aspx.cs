...
namespace MAMAMENYA.FormWeb.Balabala.Articles
{
    ...
    {
        public IList<Activity> PageData = new List<Activity>();

        public const int PageSize = 2;
        public int PageIndex, PageCount, RecordCount;

        private readonly IActivityRepository _activityRepository = new ActivityRepository();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var data = _activityRepository.GetList(query);
            PageData = data.Data;
